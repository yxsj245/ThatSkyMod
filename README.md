...
# 关于汉化贡献
为了进一步完善TSM汉化，所有人在使用过程中认为汉化地方有不妥当的，可以前往此网站进行修改 [点击前往](http://82.156.35.55:2077/projects/tsmtranslate/) \
公用账号 TSMtranslate \
密码 EeZO2uf6ch \
请注意，所有修改的都会采用版本控制模式，您的修改将不会立即发布到发行版，将于下次TSM更新时并汉化完毕后统一审核发布。您可以通过此网站下载汉化文件进行立即预览
